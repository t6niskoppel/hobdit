               ...
               <ul class="nav navbar-nav navbar-right">
                  <?php
                     if ($this->session->userdata('isUserLoggedIn')) {
                         echo'<li><a href="';
                         echo base_url() . 'index.php/welcome/account"><span class="glyphicon glyphicon-user"></span> ';
                     echo lang("header_my_account");
                     echo '</a></li>';
                     echo '<li><a href="';
                         echo base_url() . 'index.php/welcome/logout"><span class="glyphicon glyphicon-log-out"></span> ';
                     echo lang("header_log_out");
                     echo '</a></li>';
                     } else {
                         echo'<li><a href="';
                     echo base_url() . 'index.php/welcome/registration"><span class="glyphicon glyphicon-list-alt"></span> ';
                     echo lang("header_register");
                     echo '</a></li>';
                         echo'<li><a href="';
                         echo base_url() . 'index.php/welcome/login"><span class="glyphicon glyphicon-log-in"></span> ';
