...
<div class="container">
    <form action="" method="post">
        <div class="form-group">
            <input type="text" class="form-control" name="kasutajanimi" placeholder="<?php echo lang("registration_username"); ?>" required="" value="<?php echo !empty($user['name'])?$user['name']:''; ?>">
        ...
        <div class="form-group">
          <input type="password" class="form-control" name="parool" placeholder="<?php echo lang("registration_password"); ?>" required="">
          <?php echo form_error('parool','<span class="help-block">','</span>'); ?>
        </div>
        <div class="form-group">
          <input type="password" class="form-control" name="korda_parool" placeholder="<?php echo lang("registration_password_repeat"); ?>" required="">
